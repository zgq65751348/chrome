package com.google.chrome.template;
...
public abstract class SoybeanMilk {
     ...
     */
    void select(){
        System.out.println("1选择材料");
     }

     void soak(){
         System.out.println("3豆子和配料浸泡");
     }

    void beat(){
        System.out.println("4研磨");
    }

     boolean customerCreateFormula(){
        return false;
     }
}
